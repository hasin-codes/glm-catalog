...
// Deduplicate rules by slug (keep first occurrence)
const seenSlugs = new Set<string>();
export const rules: Rule[] = _allRules.filter((rule) => {
  if (seenSlugs.has(rule.slug)) return false;
